 ...
 * {@link com.liferay.portal.service.impl.RecentLayoutRevisionLocalServiceImpl} and is the
 ...
 * @see com.liferay.portal.service.base.RecentLayoutRevisionLocalServiceBaseImpl
...
public class RecentLayoutRevisionLocalServiceUtil {
	...
	*/
	...
	public static RecentLayoutRevisionLocalService getService() {
		if (_service == null) {
			_service = (RecentLayoutRevisionLocalService)PortalBeanLocatorUtil.locate(RecentLayoutRevisionLocalService.class.getName());

			ReferenceRegistry.registerReference(RecentLayoutRevisionLocalServiceUtil.class,
				"_service");
		}
