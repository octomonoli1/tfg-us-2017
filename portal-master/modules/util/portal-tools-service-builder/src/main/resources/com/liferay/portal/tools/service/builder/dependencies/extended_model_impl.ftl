 ...
 *
 * <p>
 * Helper methods and all application logic should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link ${apiPackagePath}.model.${entity.name}} interface.
 * </p>
 *
 * @author ${author}
 */
