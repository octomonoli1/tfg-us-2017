...
package com.liferay.social.networking.internal.convert.database;
...
public class SocialNetworkingDatabaseConverter implements DatabaseConverter {
	...
	public void convert(DataSource dataSource) throws Exception {
		...
		_modelMigrator.migrate(
			...
			HibernateModelUtil.getModelClassNames(
				clazz.getClassLoader(), ".*Meetups.*|.*Wall.*"));
	}
