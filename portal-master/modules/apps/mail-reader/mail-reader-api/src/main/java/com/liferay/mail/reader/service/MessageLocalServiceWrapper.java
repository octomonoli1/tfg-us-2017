...
public class MessageLocalServiceWrapper implements MessageLocalService,
	...
	*/
	...
	@Override
	public com.liferay.mail.reader.model.Message getMessage(long folderId,
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.mail.reader.model.Message> getCompanyMessages(
		long companyId, int start, int end) {
		return _messageLocalService.getCompanyMessages(companyId, start, end);
	}

	@Override
	public java.util.List<com.liferay.mail.reader.model.Message> getFolderMessages(
		long folderId) {
