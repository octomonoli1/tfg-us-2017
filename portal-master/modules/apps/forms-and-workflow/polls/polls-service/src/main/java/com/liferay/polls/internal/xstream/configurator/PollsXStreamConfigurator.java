...
package com.liferay.polls.internal.xstream.configurator;
...
public class PollsXStreamConfigurator implements XStreamConfigurator {
	...
	protected void activate() {
		_xStreamAliases = new XStreamAlias[] {
			new XStreamAlias(PollsChoiceImpl.class, "PollsChoice"),
			new XStreamAlias(PollsQuestionImpl.class, "PollsQuestion"),
			new XStreamAlias(PollsVoteImpl.class, "PollsVote")
		};
	}
