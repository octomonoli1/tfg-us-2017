...
public class CalcServiceSoapPortSoapBindingStub extends org.apache.axis.client.Stub implements com.liferay.portal.remote.axis.extender.test.service.http.CalcServiceSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("sum");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "a"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "b"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
    ...
    public int sum(int a, int b) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("urn:http.service.test.extender.axis.remote.portal.liferay.com", "sum"));
