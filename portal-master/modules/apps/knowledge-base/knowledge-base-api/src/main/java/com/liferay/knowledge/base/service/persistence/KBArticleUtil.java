...
public class KBArticleUtil {
	...
	*/
	...
	private static ServiceTracker<KBArticlePersistence, KBArticlePersistence> _serviceTracker =
		ServiceTrackerFactory.open(KBArticlePersistence.class);
}