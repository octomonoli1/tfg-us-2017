 ...
 */
@ProviderType
public class NoSuchKBArticleSelectorException extends NoSuchModelException {

	public NoSuchKBArticleSelectorException() {
	}

	public NoSuchKBArticleSelectorException(String msg) {
		super(msg);
	}
