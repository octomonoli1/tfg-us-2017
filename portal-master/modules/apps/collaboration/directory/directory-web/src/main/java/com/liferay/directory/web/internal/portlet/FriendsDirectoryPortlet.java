...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Friends Directory",
		"javax.portlet.expiration-cache=0",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + DirectoryPortletKeys.FRIENDS_DIRECTORY,
...
public class FriendsDirectoryPortlet extends MVCPortlet {
