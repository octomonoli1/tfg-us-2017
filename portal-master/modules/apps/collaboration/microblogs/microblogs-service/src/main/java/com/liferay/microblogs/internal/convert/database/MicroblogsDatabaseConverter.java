...
package com.liferay.microblogs.internal.convert.database;
...
public class MicroblogsDatabaseConverter implements DatabaseConverter {
	...
	public void convert(DataSource dataSource) throws Exception {
		...
		_modelMigrator.migrate(
			...
			HibernateModelUtil.getModelClassNames(
				clazz.getClassLoader(), ".*Microblogs.*"));
	}
