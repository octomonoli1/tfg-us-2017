...
package com.liferay.bookmarks.internal.convert.database;
...
public class BookmarksDatabaseConverter implements DatabaseConverter {
	...
	public void convert(DataSource dataSource) throws Exception {
		...
		_modelMigrator.migrate(
			...
			HibernateModelUtil.getModelClassNames(
				clazz.getClassLoader(), ".*Bookmarks.*"));
	}
