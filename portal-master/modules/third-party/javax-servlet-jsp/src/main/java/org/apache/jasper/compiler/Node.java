...
public abstract class Node implements TagConstants {
	...
	private boolean dynamic;
        private ELNode.Nodes el;
        private String expectedType;         // for deferred value
        private String expectedReturnType;   // for deferred method
        private String[] expectedParamTypes; // for deferred method
